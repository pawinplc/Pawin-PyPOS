-- PyPOS Local Database Schema (PostgreSQL)
-- University Stationery Inventory & POS System
-- Run against a local PostgreSQL instance: psql -U postgres -d pypos -f local_schema.sql
...
CREATE TABLE IF NOT EXISTS debts (
    ...
    type VARCHAR(20) NOT NULL DEFAULT 'receivable' CHECK (type IN ('receivable', 'payable')),
